...
....
Parallel kannst du schon mal ANIMAL starten (s. <<Schnellstart>>) und deine Datei `demo.asu` öffnen.
...
Um zu erreichen, dass unser _text_ und _rectangle_ Befehl im gleichen Schritt ausgeführt werden, umgeben wir diese mit `geschweiften Klammern`.
